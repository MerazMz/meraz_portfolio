...
const ProjectsSection = ({ isDesktop }: IDesktop) => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    ...
    >
      <p className="section-title-sm seq font-outfit">PROJECTS</p>
      <h1 className="section-heading seq mt-2 font-outfit">My Works</h1>
      <h2 className="text-2xl md:max-w-3xl w-full seq max-w-sm mt-2 font-outfit">
        Building the web, one project at a time from college to <span className="text-[#676767] font-nyght italic">production.</span>
      </h2>
    </div>
  );
