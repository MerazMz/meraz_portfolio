...
const COLLABORATION_STYLE = {
  ...
  TITLE: "mt-6 md:mt-8 font-medium text-4xl md:text-5xl text-center font-outfit",
};
...
const CollaborationSection = () => {
  ...
  const renderTitle = () => (
    ...
    >
      Interested in <span className="text-strong font-bold font-nyght italic">Collaboration</span>
      ?
    </h1>
  );
  ...
  return (
    <section className={COLLABORATION_STYLE.SECTION} ref={targetSection}>
      ...
      {renderSlidingText(
        " Full Stack Development  API Development DevOps",
