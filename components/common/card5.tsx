        ...
        <div className="relative w-full h-full pb-20 bg-neutral-900 border-[#676767] border group hover:border-gray-300 transition-all duration-300 cursor-pointer rounded-3xl overflow-hidden text-white">
            ...
            <div className="text-right">
                <div className="pt-6 pb-24 px-4">
                    <p className="font-semibold font-outfit text-[25px]">
                        Featuring
                    ...
                    <p className="text-[10px] text-[#676767] text-neutral-500 max-w-xs ml-auto">
            ...
            {/* LEFT PHONE */}
            <div className="absolute bottom-[-120px] left-[16%] w-[150px] rotate-[-15deg] opacity-90 z-10
            ...
            {/* CENTER PHONE */}
            <div className="absolute bottom-[-110px] left-1/2 -translate-x-1/2 w-[190px] z-20
            transition-transform duration-500 ease-out
            group-hover:scale-[1.06]">
            ...
            {/* RIGHT PHONE */}
            <div className="absolute bottom-[-120px] right-[16%] w-[150px] rotate-[15deg] opacity-90 z-10
            transition-transform duration-500 ease-out
            group-hover:scale-[1.06]">
