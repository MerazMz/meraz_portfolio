...
export function Android({ src, videoSrc, ...props }: AndroidProps) {
    return (
        <svg
            viewBox="0 0 433 882"
        ...
        >
            ...
            <g clipPath="url(#screen)">
                <path
                    ...
                    className="fill-[#E5E5E5] stroke-[#E5E5E5] stroke-[0.5] dark:fill-[#404040]"
                />
            </g>
            ...
            <defs>
                <clipPath id="screen">
                    <rect width="360" height="800" rx="33" transform="translate(9 14)" />
                </clipPath>
            </defs>
        </svg>
    )
